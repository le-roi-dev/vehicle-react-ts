            ...
            <div className='mt-12'>
                <div className="relative mb-4">
                    ...
                    <input
                        ...
                        id="username"
                        name="username"
                        className="border-none shadow-lg text-gray-900 text-sm rounded-2xl focus:ring-blue-500 block w-full ps-12 p-5  dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500"
                ...
                <div className='text-orange-400 text-sm text-right'>Forgot Password?</div>
